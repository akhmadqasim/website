...
Dengan menggunakan Layanan ini, Anda menyetujui ketentuan dalam Kebijakan Privasi ini dan [Pilihan Privasi Pengguna](/core/id/user-consent) kami.
...
Silakan hubungi kantor administrasi sekolah (Tata Usaha) Anda secara langsung. Untuk daftar sekolah yang saat ini menggunakan SIMSDIG beserta informasi kontaknya, lihat halaman [Pilihan Privasi Pengguna](/core/id/user-consent#contact).
